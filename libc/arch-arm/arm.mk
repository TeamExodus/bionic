...
$(warning TARGET_CPU_VARIANT is >> , $(TARGET_$(my_2nd_arch_prefix)CPU_VARIANT))
## removed cortex-a53 denver from below condition for example
# (oneplus 2 and nexus 9 respectively)
ifneq ($(filter krait scorpion, $(strip $(TARGET_$(my_2nd_arch_prefix)CPU_VARIANT))),)
